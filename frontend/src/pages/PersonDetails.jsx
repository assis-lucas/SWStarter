  ...
  return (
    <div className="md:max-w-[780px] mx-auto space-y-6">
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <dl className="space-y-2">
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Birth Year:</dt>
                <dd className="text-gray-900">{person.birth_year}</dd>
              </div>
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Gender:</dt>
                <dd className="text-gray-900 capitalize">{person.gender}</dd>
              </div>
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Height:</dt>
                <dd className="text-gray-900">{person.height} cm</dd>
              </div>
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Mass:</dt>
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Physical Appearance</h2>
            <dl className="space-y-2">
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Hair Color:</dt>
                <dd className="text-gray-900 capitalize">{person.hair_color}</dd>
              </div>
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Skin Color:</dt>
                <dd className="text-gray-900 capitalize">{person.skin_color}</dd>
              </div>
              <div className="flex">
                <dt className="font-medium text-gray-600 w-32">Eye Color:</dt>
        ...
        {person.homeworld && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Homeworld</h2>
